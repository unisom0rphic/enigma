...
* Некорректный формат JSON  
  _Минимизация_: few-shot prompting, json-repair  
* Некачественный RAG  
  _Минимизация_: overlap, threshold  
* Overengineering  
  _Минимизация_: бритва Оккама  
* Настройка окружения/несовпадение форматов DTO  
  _Минимизация_: командная работа, коммуникация  

**Дополнительно:**  
* Можно запутаться в монорепозитории  
* Кончатся бесплатные токены на HuggingFace во время тестирования  
* Локальная LLM не влезет в RAM ноутбука  
* Вася (наш кент)  
* Упадет Deepseek и мы будем беспомощны  
---
